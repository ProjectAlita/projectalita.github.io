...
For detailed guidance, see [Attach Images and Files in Chat](../../how-tos/chat-conversations/attach-files.md).
...
For detailed guidance, see [Using the Python Sandbox Tool in Chat](../../how-tos/chat-conversations/python-sandbox-internal-tool.md).
