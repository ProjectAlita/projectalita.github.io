...
!!! Reference
    For a short walkthrough of working in the **Next** environment, see the [Next - Quick Start Guide](../../migration/v1.7.0/next-quick-start.md).
...
For usage details, see [Canvas in Conversation](../../how-tos/chat-conversations/how-to-canvas.md).
...
* **Secrets** and **Projects**: Both subsections have been enhanced and improved for clarity and usability. See [Secrets](../../menus/settings/secrets.md) and [Projects](../../menus/settings/users.md).
