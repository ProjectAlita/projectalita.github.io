...
* **[Indexing](../how-tos/indexing/indexing-overview.md)**: Turn your documents and connected knowledge sources into searchable indexes. Use indexing to power semantic search and retrieval, so agents and pipelines can work with grounded context instead of relying only on conversation history.
* **[MCPs (Local and Remote)](../menus/mcps.md)**: Connect ELITEA to MCP servers to extend what agents and pipelines can access. Use **local MCPs** (running on your machine) or **remote MCPs** (hosted services) to bring additional tools and context into your workflows.
...
* **[Powerful Search](../how-tos/entity-management/search-entities.md)**: Find exactly what you need with robust search capabilities. Locate agents, pipelines, toolkits, and credentials by tags, names, or descriptions in seconds.
* **[Platform Management](../menus/settings/settings-overview.md)**: Handle the practical side of AI deployment with tools for [importing/exporting](../features/export-import.md), managing credentials, setting up [credentials](../how-tos/credentials-toolkits/how-to-use-credentials.md), and organizing [users and projects](../menus/settings/users.md) - all through an intuitive interface.
* **[Community Engagement](../features/public-project.md)**: Share your best work and discover what others have created. Publish, modify, and collaborate on agents, pipelines, and to build a vibrant ecosystem of AI solutions.
