...
![create project](../../img/how-tos/toolkits/google_places/create_project_new.png)
![new project](../../img/how-tos/toolkits/google_places/new_project.png)
![save project](../../img/how-tos/toolkits/google_places/save_project.png)

4.  **Enable the Places API:** Once your project is created/selected, navigate to the "APIs & Services" dashboard. 

![APIs & Services](../../img/how-tos/toolkits/google_places/APIs_Services.png)

Click on "+ ENABLE APIS AND SERVICES" and search for "Places API". Select the "Places API" and click "Enable".
![enable API](../../img/how-tos/toolkits/google_places/enable_API.png)
![places API](../../img/how-tos/toolkits/google_places/places_API.png)
![enable](../../img/how-tos/toolkits/google_places/enable.png)
...
![credentals](../../img/how-tos/toolkits/google_places/credentials.png)
2.  **Create Credentials:** Click on "+ CREATE CREDENTIALS" and select "API key".
![create credentals](../../img/how-tos/toolkits/google_places/create_credentials.png)
...
![copy_key](../../img/how-tos/toolkits/google_places/copy_key.png)
...
![toolkit_config](../../img/how-tos/toolkits/google_places/toolkit_config.png)
