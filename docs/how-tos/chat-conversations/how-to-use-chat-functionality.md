...
2. A new conversation entry will appear. By default, it will be named "New Conversation". You can rename it later (see [Conversation Actions](#conversation-actions-sidebar)).  
3. **Add Participants**: Click the **PARTICIPANTS +** button within the new conversation window to add desired Models, Prompts, Datasources, or Agents (See [Adding Participants](#adding-participants-to-a-conversation)).  
